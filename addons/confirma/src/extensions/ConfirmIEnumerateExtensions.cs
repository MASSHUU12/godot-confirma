...
public static class ConfirmIEnumerateExtensions
{
	...
	public static void ConfirmContains<T>(IEnumerable<T> actual, T expected, string? message = null)
	{
	...
	public static void ConfirmNotContains<T>(IEnumerable<T> actual, T expected, string? message = null)
	{
		if (!actual.Contains(expected)) return;
	...
	public static void ConfirmAllMatch<T>(IEnumerable<T> actual, Func<T, bool> predicate, string? message = null)
	{
	...
	public static void ConfirmAnyMatch<T>(IEnumerable<T> actual, Func<T, bool> predicate, string? message = null)
	{
	...
	public static void ConfirmNoneMatch<T>(IEnumerable<T> actual, Func<T, bool> predicate, string? message = null)
	{
	...
	public static void ConfirmElementsAreUnique<T>(IEnumerable<T> actual, string? message = null)
	{
	...
	public static void ConfirmElementsAreDistinct<T>(IEnumerable<T> actual, IEnumerable<T> expected, string? message = null)
	{
	...
	public static void ConfirmElementsAreOrdered<T>(IEnumerable<T> actual, string? message = null)
	{
	...
	public static void ConfirmElementsAreInRange<T>(IEnumerable<T> actual, T from, T to, string? message = null)
	...
	public static void ConfirmElementsAreEquivalent<T>(IEnumerable<T> actual, IEnumerable<T> expected, string? message = null)
	{
